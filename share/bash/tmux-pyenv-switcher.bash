...
_tmux-pyenv-switcher() {

    COMPREPLY=()
    local program=tmux-pyenv-switcher
    ...
    case ${MYWORDS[0]} in
      ...
      exec)
        ...
        __tmux-pyenv-switcher_handle_options_flags
          ...
          2)
              __comp_current_options || return
                _tmux-pyenv-switcher_exec_param_versions_completion
          ;;
          *)
            __comp_current_options true || return # after parameters
            case ${MYWORDS[$INDEX-1]} in
...
_tmux-pyenv-switcher_compreply() {
...
__tmux-pyenv-switcher_dynamic_comp() {
    local argname="$1"
    local arg="$2"
    ...
    _tmux-pyenv-switcher_compreply "$comp"
}

function __tmux-pyenv-switcher_handle_options() {
    local i j
    declare -a copy
...
function __tmux-pyenv-switcher_handle_flags() {
    local i j
    declare -a copy
    local last="${MYWORDS[$INDEX]}"
    local max=`expr ${#MYWORDS[@]} - 1`
...
__tmux-pyenv-switcher_handle_options_flags() {
    __tmux-pyenv-switcher_handle_options
    __tmux-pyenv-switcher_handle_flags
}
...
__comp_current_options() {
    ...
    if [[ -n $always || ${MYWORDS[$INDEX]} =~ ^- ]]; then
      ...
      __tmux-pyenv-switcher_dynamic_comp 'options' "$options_spec"
...
complete -o default -F _tmux-pyenv-switcher tmux-pyenv-switcher
